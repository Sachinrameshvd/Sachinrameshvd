...
<sub>AI/ML Engineer — I ship models that survive production</sub>
...
<table width="92%" border="2" bordercolor="#FFFFFF" cellspacing="0" cellpadding="0">
<tr><td bgcolor="#0d0d0d">

<table width="100%" border="0" cellpadding="22">
<tr><td>

<img src="https://img.shields.io/badge/01-FFFFFF?style=for-the-badge&labelColor=FFFFFF&color=FFFFFF"/>
...
+ Inference bottleneck: ~9s -> exported to ONNX + rebuilt serving -> <1s (9x)
+ SHAP explanations shipped with every prediction
...
<img src="https://img.shields.io/badge/02-FFFFFF?style=for-the-badge&labelColor=FFFFFF&color=FFFFFF"/>
...
+ DoWhy causal inference: fridge placement CAUSES freshness change
  -> up to 5.2 extra shelf-life days
```
...
<img src="https://img.shields.io/badge/03-FFFFFF?style=for-the-badge&labelColor=FFFFFF&color=FFFFFF"/>
